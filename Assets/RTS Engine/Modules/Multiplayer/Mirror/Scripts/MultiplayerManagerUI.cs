...
namespace RTSEngine.Multiplayer.Mirror
{
    public class MultiplayerManagerUI : MonoBehaviour, IMultiplayerManagerUI
    {
        ...
        private TMP_InputField portInput = null;
        ...
        public void Init(IMultiplayerManager multiplayerMgr)
        {
            ...
            addressInput.onValueChanged.AddListener(OnServerAccessDataChange);
            portInput.onValueChanged.AddListener(OnServerAccessDataChange);
        ...
        private void OnServerAccessDataChange(string newValue)
        {
