...
namespace RTS_Cam
{
    ...
    public class RTS_Camera : MonoBehaviour
    {
        ...
        public float keyboardMovementSpeed = 10f; //speed with keyboard movement
        ...
        public float maxHeight = 5f; //maximal height
        ...
        public float limitX = 1f; //x limit of map
        public float limitY = 1f; //z limit of map
